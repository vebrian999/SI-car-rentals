        ...
        <div id="content" class="content">
            <div class="mt-20 p-4 sm:ml-64 md:mt-10">
                <div class="p-4 border-2 border-gray-200 rounded-lg mt-14">
                    <div class="flex items-center justify-center h-32 mb-4 rounded bg-gray-50">
...
<div id="formTambahMobil" class="hidden">
    <form action="dashboard_product.php" method="POST" enctype="multipart/form-data" class="space-y-4">
